    ...
    <div class="newsdiv">
        <div class="right_block narrow_N ">
            ...
            <p>
                ...
                подтверждаете свое согласие на обработку компанией ПАО Астраханский порт&nbsp;персональных данных: сбор,
            ...
            <p>
                Компания ПАО Астраханский порт&nbsp;гарантирует конфиденциальность получаемой информации. Обработка
                персональных данных осуществляется в целях эффективного исполнения заказов, договоров и иных
                обязательств, принятых компанией &lt;КОМПАНИЯ&gt; в качестве обязательных к исполнению.&nbsp;
            </p>
            <p>
                ...
                согласие на передачу ваших персональных данных. ПАО Астраханский порт&nbsp;гарантирует, что
            ...
            <p>
                ...
                направив письменное уведомления на адрес: 414041, г. Астрахань, ул. Пушкина, д. 66, с пометкой «Отзыв
                согласия на обработку персональных данных».&nbsp;
            </p>
            <p>
                Обращаем ваше внимание, что отзыв согласия на обработку персональных данных влечёт за собой удаление
                Вашей учётной записи с Интернет-сайта <a href="ПАО%20Астраханский%20порт">https://</a><a
                    href="ПАО%20Астраханский%20порт">astrakhanport.ru</a>, а также уничтожение записей, содержащих ваши
                персональные данные, в системах обработки персональных данных компании ПАО Астраханский порт, что может
                сделать невозможным пользование интернет-сервисами компании ПАО Астраханский порт.&nbsp;
            </p>
            <p>
